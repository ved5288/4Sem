...
;====IMPORTANT ADDRESSES======================
;PGDIR BASE ADRRESS : 0xE000				==
;PGTABLE BASE ADDRESS : 0XF000				==
;=============================================
...
;=======GENERATE PAGE FAULT====================
	...
	;====================================
	;GS : Base 0X0000
	;VA : Base + Offset = 0xFFFFE030
	;| PGDIR IDX   | PGTBLE IDX  | OFFSET|
	;| (0x3FF <<2) | (0x3FE <<2) | 0x030 |
	;1.PGDIR Entry = 0xe000(base) + 0xFFC(off)  
	;2.PGTBL Entry = 0xf000(base) + 0xFF8(off)
	;3.Phy Address = 0xb000(base) + 0x030(off) //Page not present
...
;=======JUMPING CODE ==================
	...
	;====================================
	;GS : Base 0X0000
	;VA : Base + Offset = 0xFFFFC000
	;| PGDIR IDX   | PGTBLE IDX  | OFFSET|
	;| (0x3FF <<2) | (0x3FC <<2) | 0x000 |
	;1.PGDIR Entry = 0xe000(base) + 0xFFC(off)  
	;2.PGTBL Entry = 0xf000(base) + 0xFF0(off)
	;3.Phy Address = 0xb000(base) + 0x000(off)
	...
	;Segment No: 0x50
	;Segment Base: 0x0000
	;VA : Base + Offset = 0xFFFFF400
	;| PGDIR IDX   | PGTBLE IDX  | OFFSET|
	;| (0x3FF <<2) | (0x3FF <<2) | 0x400 |
	;1.PGDIR Entry = 0xe000(base) + 0xFFC(off)  
	;2.PGTBL Entry = 0xf000(base) + 0xFFC(off)
	;3.Phy Address = 0xa000(base) + 0x400(off)
